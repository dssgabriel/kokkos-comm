...
TYPED_TEST(MpiSendRecv, Contig3DStandard) {
  auto v = test_utils::build_view<typename TestFixture::Scalar, 3>(test_utils::Contig{}, "v", 13, 10, 7);
  test_mpi_send_comm_mode_recv(v, KokkosComm::mpi::CommModeStandard{});
}
TYPED_TEST(MpiSendRecv, Contig3DReady) {
  auto v = test_utils::build_view<typename TestFixture::Scalar, 3>(test_utils::Contig{}, "v", 13, 10, 7);
  test_mpi_send_comm_mode_recv(v, KokkosComm::mpi::CommModeReady{});
}
TYPED_TEST(MpiSendRecv, Contig3DSynchronous) {
  auto v = test_utils::build_view<typename TestFixture::Scalar, 3>(test_utils::Contig{}, "v", 13, 10, 7);
  test_mpi_send_comm_mode_recv(v, KokkosComm::mpi::CommModeSynchronous{});
}

TYPED_TEST(MpiSendRecv, NonContig3DStandard) {
  auto v = test_utils::build_view<typename TestFixture::Scalar, 3>(test_utils::NonContig{}, "v", 13, 10, 7);
  test_mpi_send_comm_mode_recv(v, KokkosComm::mpi::CommModeStandard{});
}
TYPED_TEST(MpiSendRecv, NonContig3DReady) {
  auto v = test_utils::build_view<typename TestFixture::Scalar, 3>(test_utils::NonContig{}, "v", 13, 10, 7);
  test_mpi_send_comm_mode_recv(v, KokkosComm::mpi::CommModeReady{});
}
TYPED_TEST(MpiSendRecv, NonContig3DSynchronous) {
  auto v = test_utils::build_view<typename TestFixture::Scalar, 3>(test_utils::NonContig{}, "v", 13, 10, 7);
  test_mpi_send_comm_mode_recv(v, KokkosComm::mpi::CommModeSynchronous{});
}
